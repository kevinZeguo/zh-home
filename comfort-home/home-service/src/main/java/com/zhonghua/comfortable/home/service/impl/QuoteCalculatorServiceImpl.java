...
public class QuoteCalculatorServiceImpl implements QuoteCalculatorService {
     ...
     * @return
     */
    private List<Float> calculateModulePrice(Integer a, float b, Integer c, Integer d, Integer e,
                                             List<Integer> chooseProductIdList, Map<Integer, DefProduct> productMap)
            throws Exception {
     ...
     * @param productList
     */
    private void calculateProductPrice(UserHouse userHouse, List<UserChooseProduct> chooseProductList,
                                       List<DefProduct> productList)
            throws Exception {
     ...
     * @return
     */
    private List<Float> calculateProductPrice(Integer A, float B, Integer C, Integer D, Integer E, DefProduct product)
            throws Exception {
     ...
     * @return
     */
    private List<Float> calculateProductPriceByRangeFromTPPP(float b, float c, float d, DefProduct product)
            throws Exception {
        List<Float>           rangePrice    = new ArrayList<>();
        List<DefProductPrice> productPrices = product.getProductPrices();
